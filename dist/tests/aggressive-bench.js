...
const ITERATIONS = 5000000; // 5M iterations to test sustained performance
...
console.log(`  ${(1000000 / ops).toFixed(2)}μs per operation\n`);
...
console.log(`  Sustained performance: ${ops > 3000000 ? '✅ TARGET MET' : '❌ BELOW TARGET'}\n`);
// Final analysis
console.log('╔══════════════════════════════════════════════════════════╗');
