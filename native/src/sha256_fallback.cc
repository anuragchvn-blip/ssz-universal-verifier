/**
 * Software fallback SHA-256 implementation
 * Used when hardware acceleration not available
 */
...
extern "C" void sha256_fallback(const uint8_t* data, size_t len, uint8_t* hash) {
  uint32_t h[8] = {
