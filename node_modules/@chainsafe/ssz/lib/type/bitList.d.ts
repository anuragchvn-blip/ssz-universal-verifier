...
type BitArrayDeserialized = {
    uint8Array: Uint8Array;
    bitLen: number;
};
export declare function deserializeUint8ArrayBitListFromBytes(data: Uint8Array, start: number, end: number, reuseBytes?: boolean): BitArrayDeserialized;
export {};
