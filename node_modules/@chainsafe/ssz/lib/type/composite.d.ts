...
export type CompositeView<T extends CompositeType<unknown, unknown, unknown>> = T extends CompositeType<unknown, infer TV, unknown> ? TV : never;
/** ViewDU type of a CompositeType */
export type CompositeViewDU<T extends CompositeType<unknown, unknown, unknown>> = T extends CompositeType<unknown, unknown, infer TVDU> ? TVDU : never;
...
export declare abstract class CompositeType<V, TV, TVDU> extends Type<V> {
    ...
    protected blocksBuffer: Uint8Array<ArrayBuffer>;
    constructor(
    /**
     * Caches `hashTreeRoot()` result for struct values.
     *
    ...
    hashTreeRootInto(value: V, output: Uint8Array, offset: number, safeCache?: boolean): void;
