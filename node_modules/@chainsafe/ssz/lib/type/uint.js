...
export const uintNumberByteLens = [1, 2, 4, 8];
export const uintBigintByteLens = [1, 2, 4, 8, 16, 32];
/**
 ...
 */
export class UintNumberType extends BasicType {
    byteLength;
    typeName;
    itemsPerChunk;
    fixedSize;
 ...
 */
export class UintBigintType extends BasicType {
    byteLength;
    typeName;
