import { subtreeFillToContents, toSnapshot, treeZeroAfterIndex, zeroNode } from "@chainsafe/persistent-merkle-tree";
import { tree_serializeToBytesArrayComposite } from "../type/arrayComposite.js";
import { zeroSnapshot } from "../util/snapshot.js";
import { ArrayCompositeTreeViewDU } from "./arrayComposite.js";
export class ListCompositeTreeViewDU extends ArrayCompositeTreeViewDU {
    type;
    _rootNode;
    ...
    serializeToBytes(output, offset) {
        ...
        return tree_serializeToBytesArrayComposite(this.type.elementType, this._length, this.type.chunkDepth, chunksNode, output, offset, this.nodes);
    }
