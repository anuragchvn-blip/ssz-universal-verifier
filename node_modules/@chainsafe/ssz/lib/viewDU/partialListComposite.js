import { getNodesAtDepth, subtreeFillToContents, zeroNode } from "@chainsafe/persistent-merkle-tree";
 ...
 */
export class PartialListCompositeTreeViewDU extends ListCompositeTreeViewDU {
    type;
    _rootNode;
    snapshot;
    ...
    sliceFrom(index) {
        ...
        return new PartialListCompositeTreeViewDU(this.type, newRootNode, zeroSnapshot(this.type.chunkDepth));
    }
    serializeToBytes() {
    ...
    rootNodeToViewDU(rootNode, cache) {
        return new PartialListCompositeTreeViewDU(this.type, rootNode, this.snapshot, cache);
    }
}
