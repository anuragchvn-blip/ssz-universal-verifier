...
import { ContainerTypeGeneric } from "../view/profile.ts";
...
export declare function getProfileTreeViewDUClass<Fields extends Record<string, Type<unknown>>>(type: ContainerTypeGeneric<Fields>): ContainerTreeViewDUTypeConstructor<Fields>;
